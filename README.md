...
This will compile the project and produce an executable named `main` that will be executed automatically
...
The ID number is managed automatically by the system.
...
- This project uses standard dynamic memory allocation (malloc, realloc, and free) to automatically adjust the size of the student array as needed. Initially, no memory is allocated. The first initialization function, initStudentList, allocates memory for the array using malloc.
